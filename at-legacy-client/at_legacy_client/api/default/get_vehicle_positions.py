...
def _get_kwargs(
    *,
    ...
    url = "{}/vehiclelocations".format(client.base_url)
...
def sync_detailed(
    *,
    ...
    """Vehicle Positions
     ...
     Returns realtime GTFS vehicle locations for the active trips in the Auckland region, updated at
    least every 30s. Protobuf supported if the Accept header is set to application/x-protobuf.
