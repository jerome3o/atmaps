...
def sync_detailed(
    *,
    ...
    """Combined Feed
     ...
     Returns realtime GTFS vehicle locations, trip updates and alerts for the active trips in the
    Auckland region, updated at least every 30s. Protobuf supported if the Accept header is set to
